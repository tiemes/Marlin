...
#define STRING_CONFIG_H_AUTHOR "(tiemes, conf.HBP)" // Who made the changes.
...
#define HOTEND_OFFSET_X {0.0, 64.50} // (in mm) for each extruder, offset of the hotend on the X axis
